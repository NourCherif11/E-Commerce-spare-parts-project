    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Mixer</span>
            </nav>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{ $mixer->validImage }}" alt="">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square"href="{{ route('detail', ['id' => $mixer->id]) }}" data-id="{{ $mixer->id }}"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">{{$mixer['name']}}</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>{{$mixer['price']}} TND</h5>
                            </div>
                        </div>
                    </div>
                </div>
